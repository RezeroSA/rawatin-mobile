...
class DetailPesananSelesai extends StatefulWidget {
  DetailPesananSelesai({super.key, required this.orderId});
  final int orderId;

  @override
  State<DetailPesananSelesai> createState() => _DetailPesananSelesaiState();
}

class _DetailPesananSelesaiState extends State<DetailPesananSelesai> {
  ...
  Future<void> _getOrder() async {
    ...
    print(res.data['data']['order']['customer_notes']);
