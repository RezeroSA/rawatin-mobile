...
class CariAlamatEmergency extends StatefulWidget {
  const CariAlamatEmergency({super.key});

  @override
  State<CariAlamatEmergency> createState() => _CariAlamatEmergencyState();
}

class _CariAlamatEmergencyState extends State<CariAlamatEmergency> {
  @override
              ...
              SizedBox(
                ...
                child: TextFormField(
                  decoration: const InputDecoration(
                    ...
                    labelStyle: TextStyle(color: RawatinColorTheme.red),
                    border: OutlineInputBorder(
                      borderSide: BorderSide(color: RawatinColorTheme.red),
