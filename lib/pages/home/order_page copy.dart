...
class _OrderPageState extends State<OrderPage> with TickerProviderStateMixin {
  ...
  Future getWaitingInProcessOrder() async {
    orders = await _orderService.getWaitingOrders(userId: box.read('phoneNum'));
  ...
  Widget build(BuildContext context) {
    // Future<List<Order>> postsFuture = getWaitingInProcessOrder();
  ...
  Widget buildOrder() {
    return FutureBuilder(
      future: getWaitingInProcessOrder(),
