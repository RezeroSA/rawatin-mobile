...
class ServisMotor extends StatefulWidget {
  const ServisMotor({super.key});

  @override
  State<ServisMotor> createState() => _ServisMotorState();
}

class _ServisMotorState extends State<ServisMotor> {
  String service = 'Servis Motor';
  String tipeLayanan = 'Tune Up';
  bool isTuneUp = true;
  bool isBerkala = false;
  bool isBodi = false;

  double tarifLayanan = 150000;
  double tarif = 0;
  double total = 0;
                            ...
                            SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Menjaga performa mesin motor kamu tetap optimal',
                                    style: TextStyle(
                                        color: RawatinColorTheme.black,
                                        fontWeight: FontWeight.w400,
                                        fontSize: 12),
                            ...
                            SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Poles bodi motor kamu sampe kinclong',
                                    style: TextStyle(
                                        color: RawatinColorTheme.black,
                                        fontWeight: FontWeight.w400,
                                        fontSize: 12),
